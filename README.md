...
* Solutions for the Jupyter notebooks are available for instructors as explained [here](https://courses.seas.harvard.edu/climate/eli/Courses/EPS101/index.html).
...
MIT License—see LICENSE file. You are free to use, adapt, and redistribute these scripts with attribution.


## Contact:

Eli Tziperman, eli@eps.harvard.edu, Department of Earth and Planetary Sciences, Harvard University.
