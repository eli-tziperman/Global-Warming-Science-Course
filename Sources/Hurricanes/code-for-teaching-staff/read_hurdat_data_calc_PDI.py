""" Read the HURDAT2 dataset, saves and plots the PDI, annual and 5-year smoothed.
...
class Hurricane:
    ...
    def __str__(self):
        """Allows a Hurricane to be printed for debugging."""
...
class read_and_analyze_HURDAT:
    ...
    def __init__(self, hurdat_path):
        """Construct read_and_analyze_HURDAT
        
        Open and parse the HURDAT2 data file; read_and_analyze_HURDAT
        contains a full list of hurricanes and velocities.
        ...
        for i in lines:
            ...
            if self._is_header(i):
                ...
                if vel >= 0:
                    # discard negative (invalid) values from
                    # _extract_vel_from_line()
    ...
    def _extract_vel_from_line(self, line):
        ...
        if not time in valid_times:
            ...
            return -1
        velocity = line[38:41]    # the measured wind velocity
    ...
    def calc_hurricane_PDI(self, hurricane):
        ...
        """
        pdi = 0
        speed_threshold = 30.4142    # this is in knots; 35 mph
